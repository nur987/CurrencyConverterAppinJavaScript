...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        ...
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "KGS" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url =`https://v6.exchangerate-api.com/v6/b024b0def0929e789e09b329/latest/${fromCurrency.value}`;
